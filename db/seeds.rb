...
# Group.create!(title: "Algebra Class", description: "Come to my classes!", timeline: "2019-12-04", location: "Shenzhen", user_id: 1, subject_id: 1)
# Group.create!(title: "Maths Class", description: "Welcome to my classes!", timeline: "2019-12-04", location: "Shenzhen", user_id: 3, subject_id: 1)

# Group.create!(title: "English Oral Exam", description: "Come to my classes!", timeline: "2019-12-04", location: "Shenzhen", user_id: 2, subject_id: 2)
...
# Group.create!(title: "Chinese Lessons", description: "Join my classes!", timeline: "2019-12-04", location: "Shenzhen", user_id: 4, subject_id: 4)

# Group.create!(title: "Moral Foundations of Politics", description: "We'll talk about politics :)", timeline: "2019-12-04", location: "Shenzhen", user_id: 5, subject_id: 5)

# Group.create!(title: "Financial Markets", description: "Let's learn more about financial markets!", timeline: "2019-12-04", location: "Shenzhen", user_id: 6, subject_id: 6)
