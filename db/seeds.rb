...
Subject.create!(id: 1, name: "Mathematics", category: "Sciences", number_of_learners: "4")
Subject.create!(id: 2, name: "English", category: "Language", number_of_learners: "6")
Subject.create!(id: 3, name: "Algorithms", category: "IT", number_of_learners: "4")
Subject.create!(id: 4, name: "Chinese", category: "Language", number_of_learners: "6")
...
User.create!(id: 5, name: "Ryan", email: "ryan@gmail.com", password: "123234", created_at: "2019-12-02", updated_at: "2019-12-04")
User.create!(id: 6, name: "Paula", email: "paula@gmail.com", password: "123765", created_at: "2019-12-02", updated_at: "2019-12-04")


Group.create!(id: 1, title: "Algebra Class", description: "Come to my classes!", timeline: "2019-12-04", location: "Shenzhen", user_id: 1, subject_id: 1)
Group.create!(id: 2, title: "Maths Class", description: "Welcome to my classes!", timeline: "2019-12-04", location: "Shenzhen", user_id: 3, subject_id: 1)

Group.create!(id: 3, title: "English Oral Exam", description: "Come to my classes!", timeline: "2019-12-04", location: "Shenzhen", user_id: 2, subject_id: 2)
Group.create!(id: 8, title: "English Grammar", description: "Come to my classes!", timeline: "2019-12-04", location: "Shenzhen", user_id: 3, subject_id: 2)
...
Group.create!(id: 7, title: "Financial Markets", description: "Let's learn more about financial markets!", timeline: "2019-12-04", location: "Shenzhen", user_id: 6, subject_id: 6)
